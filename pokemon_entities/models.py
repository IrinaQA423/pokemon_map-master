...
class PokemonEntity(models.Model):
    ...
    strength = models.IntegerField(default=10, verbose_name="Сила", null=True, blank=True)
    defence = models.IntegerField(default=10, verbose_name="Защита", null=True, blank=True)
    stamina = models.IntegerField(default=10, verbose_name="Выносливость", null=True, blank=True)
